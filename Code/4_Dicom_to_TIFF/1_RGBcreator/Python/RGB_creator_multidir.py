...
#
# Creating RGB images from dicom files + options to invert and rotate images
#
# step 1, select the options
# Step 2, run the program  (If run from terminal (command:  python RGB_creator_multidir.py)

## Image folder and image files have the same name
### NAME the image folder where the files are stored as: LFIC_MR_0001_20190101
...
rename_and_invert   =  'YES'      #choose between "YES" and "NO" to have images inverted  !!!!!!
   #ROTATION OPTION
up_down_rotation    =  'YES'       #choose between "YES" and "NO" to have images rotated  !!!!!!
left_right_rotation =  'YES'       #choose between "YES" and "NO" to have images rotated  !!!!!!
rotate              =  'no'       #this rotate clockwise of 180deg (not very useful) choose between "YES" and "NO" to have images rotated  !!!!!!
